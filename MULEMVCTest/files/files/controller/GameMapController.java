...
public class GameMapController {
    ...
    public void createDefaultGameMap() {
        MapTiles[][] aMap = new MapTiles[9][5];
    ...
    public void addMule(int x, int y, int m) {
        ...
        if (!aMap[x][y].getMule(m)) {
            ...
            mapView.getChildren().addAll(mule, t);
        }
    }
    ...
    public <T> void addEventHandler(EventType e, EventHandler handle) {
        mapView.addEventHandler(e, handle);
    }
    
    /**
     * getter for MapView
     * @return GameMapView the mapView
     */
