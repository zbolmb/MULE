...
public abstract class MapTiles {
    ...
    public void setCrystalite(boolean crystite) { this.crystite = crystite; }
    ...
    public boolean getMule(int m) { return mules[m]; }
    public void setMule(int m) { mules[m] = true; }
    public boolean[] getMules() { return mules; }
}
